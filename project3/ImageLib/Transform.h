...
public:
	...
	CVector3 Normalize() const;                         // normalization
	CVector3 operator*(double d) const;                 // scalar product
	CTransform3x3 operator*(const CVector3 &v) const;   // outer product
	double dot(const CVector3 &v) const;                // dot product
	CVector3 cross(const CVector3 &v) const;            // cross product
